...
image_name="${IMAGE_NAME:-wsi-viewer-frontend}"
...
Build the WSIViewer frontend builder image with Docker Buildx.

Options:
  --image NAME          Image repository/name (default: wsi-viewer-frontend)
